...
// The code is valid for 1:30; "Resend Code" unlocks at the same moment, so
// once it expires the shopper must request a new one.
export const OTP_RESEND_SECONDS = 90;
export const OTP_TTL_SECONDS = OTP_RESEND_SECONDS;
